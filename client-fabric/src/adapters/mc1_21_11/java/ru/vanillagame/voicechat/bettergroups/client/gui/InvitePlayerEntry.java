...
public class InvitePlayerEntry extends ListScreenEntryBase<InvitePlayerEntry> {
    ...
    public void renderContent(GuiGraphics guiGraphics, int mouseX, int mouseY, boolean hovered, float delta) {
        ...
        guiGraphics.blit(RenderPipelines.GUI_TEXTURED, skin.body().texturePath(), skinX, skinY,
                8F, 8F, SKIN_SIZE, SKIN_SIZE, 8, 8, 64, 64);
        guiGraphics.blit(RenderPipelines.GUI_TEXTURED, skin.body().texturePath(), skinX, skinY,
                40F, 8F, SKIN_SIZE, SKIN_SIZE, 8, 8, 64, 64);
        ...
        if (minecraft.font.width(name) > textSpace) {
            ...
            guiGraphics.drawString(minecraft.font, name, textX, textY, 0xFFFFFFFF, false);
        }
    }
}
